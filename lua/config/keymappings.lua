...
--  │ Comment Box                                              │
--  ╰──────────────────────────────────────────────────────────╯
keymap({ "n", "v" }, "<Leader>cb", "<Cmd>CBccbox<CR>", silent) -- Titles
keymap({ "n", "v" }, "<Leader>ct", "<Cmd>CBllline<CR>", silent) -- Named parts
keymap({ "n", "v" }, "<Leader>cl", "<Cmd>CBline<CR>", silent) -- Simple line
keymap({ "n", "v" }, "<Leader>cm", "<Cmd>CBllbox14<CR>", silent) -- Marked comments
keymap({ "n", "v" }, "<Leader>cd", "<Cmd>CBd<CR>", silent) -- Removing a box

--  ╭──────────────────────────────────────────────────────────╮
--  │ Comment function                                         │
--  ╰──────────────────────────────────────────────────────────╯
keymap("n", "<Leader>nf", ":lua require('neogen').generate()<CR>", silent)
