...
-- Ecovim Colors
vim.api.nvim_set_hl(0, "Primary", { fg = "#488dff" })
vim.api.nvim_set_hl(0, "Secondary", { fg = "#FFA630" })

vim.api.nvim_set_hl(0, "PrimaryBold", { bold = true, fg = "#488DFF" })
vim.api.nvim_set_hl(0, "SecondaryBold", { bold = true, fg = "#FFA630" })

vim.api.nvim_set_hl(0, "Header", { bold = true, fg = "#488DFF" })
vim.api.nvim_set_hl(0, "HeaderInfo", { bold = true, fg = "#FFA630" })
vim.api.nvim_set_hl(0, "Footer", { bold = true, fg = "#FFA630" })
